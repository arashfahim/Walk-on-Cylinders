...
T_total    = 16.0       # total physical time
S          = 4.0       # only used in R = sqrt(T_rem/S)
DIM        = 2
N_ZEROS    = 200
INV_T_GRID = 2000      # grid points for time‐CDF inversion
INV_R_GRID = 500       # grid points for spatial‐CDF inversion
